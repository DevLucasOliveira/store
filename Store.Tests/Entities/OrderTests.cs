...
namespace Store.Tests.Domain
{
    ...
    {
        private readonly Customer _customer = new Customer("Lucas Oliveira", "lucas@oliveira.com");
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_novo_item_com_quantidade_zero_ou_menor_o_mesmo_não_deve_ser_adicionado()
        {
            var order = new Order(_customer, 0, null);
        ...
        [TestMethod]
        [TestCategory("Domain")]
        public void Dado_um_cliente_sem_nome()
        {
            var customer = new Customer(null, "Lucas@dev.com");
